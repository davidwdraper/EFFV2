 ...
 *
 * Purpose:
 * - Orchestrate GET /api/prompt/v1/:dtoType/read/:id
...
import * as PromptReadPipeline from "./pipelines/prompt.read.handlerPipeline";
...
export class PromptReadController extends ControllerBase {
