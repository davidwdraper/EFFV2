// backend/services/handler-test/src/controllers/handler-test.create.controller/handler-test.create.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate PUT /api/handler-test/v1/:dtoType/create
...
import * as HandlerTestCreatePipeline from "./pipelines/create.handlerPipeline";
...
export class HandlerTestCreateController extends ControllerJsonBase {
  ...
  public async put(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "handler-test": {
        ...
        const steps = HandlerTestCreatePipeline.getSteps(ctx, this);
