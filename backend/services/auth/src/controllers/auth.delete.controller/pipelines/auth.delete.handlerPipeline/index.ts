// backend/services/auth/src/controllers/auth.delete.controller/pipelines/auth.delete.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "auth" DELETE.
