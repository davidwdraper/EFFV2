// backend/services/gateway/src/controllers/gateway.read.controller/gateway.read.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate GET /api/gateway/v1/:dtoType/read/:id
...
import * as GatewayReadPipeline from "./pipelines/gateway.read.handlerPipeline";
...
export class GatewayReadController extends ControllerJsonBase {
  ...
  public async get(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "gateway": {
        const steps = GatewayReadPipeline.getSteps(ctx, this);
