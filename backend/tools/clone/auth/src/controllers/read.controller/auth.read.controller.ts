// backend/services/auth/src/controllers/auth.read.controller/auth.read.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate GET /api/auth/v1/:dtoType/read/:id
...
import * as AuthReadPipeline from "./pipelines/auth.read.handlerPipeline";
...
export class AuthReadController extends ControllerJsonBase {
  ...
  public async get(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "auth": {
        const steps = AuthReadPipeline.getSteps(ctx, this);
