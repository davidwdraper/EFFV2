// backend/services/auth/src/controllers/auth.update.controller/handlers/bagToDb.update.handler.ts
/**
 * Docs:
 ...
 *
 * Inputs (ctx):
 * - "bag": DtoBag<AuthDto>   (UPDATED singleton; from ApplyPatchUpdateHandler)
 *
 * Outputs (ctx):
 * - "result": { ok: true, id }
 * - "status": 200
