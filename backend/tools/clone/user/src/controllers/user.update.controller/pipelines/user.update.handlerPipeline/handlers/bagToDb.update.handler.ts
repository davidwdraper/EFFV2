// backend/services/user/src/controllers/user.update.controller/handlers/bagToDb.update.handler.ts
/**
 * Docs:
 ...
 *
 * Inputs (ctx):
 * - "bag": DtoBag<UserDto>   (UPDATED singleton; from ApplyPatchUpdateHandler)
 *
 * Outputs (ctx):
 * - "result": { ok: true, id }
 * - "status": 200
