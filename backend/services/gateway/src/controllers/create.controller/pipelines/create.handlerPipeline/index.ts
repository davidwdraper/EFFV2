// backend/services/gateway/src/controllers/gateway.create.controller/pipelines/gateway.create.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "gateway" CREATE.
