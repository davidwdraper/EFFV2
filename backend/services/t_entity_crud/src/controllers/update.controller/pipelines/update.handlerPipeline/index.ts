// backend/services/t_entity_crud/src/controllers/xxx.update.controller/pipelines/xxx.update.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "xxx" UPDATE.
