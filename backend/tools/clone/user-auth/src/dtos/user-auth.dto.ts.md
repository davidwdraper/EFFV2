 ...
 *
 * Purpose:
 * - Concrete DTO for the template service ("user-auth").
...
export class UserAuthDto extends DtoBase {
  ...
  public constructor(
    ...
    super(secretOrMeta);
    this.setCollectionName(UserAuthDto.dbCollectionName());
  }
  ...
  public static fromBody(json: unknown, opts?: { validate?: boolean }): UserAuthDto {
