// backend/services/prompt/src/controllers/prompt.update.controller/handlers/applyPatch.update.handler.ts
/**
 * Docs:
 ...
 *
 * Inputs (ctx):
 * - "existingBag": DtoBag<PromptDto>   (singleton; from LoadExistingUpdateHandler)
 * - "bag": DtoBag<PromptDto>           (singleton; from BagPopulateGetHandler — the patch)
 *
 * Outputs (ctx):
