// backend/services/test-log/src/controllers/test-log.read.controller/test-log.read.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate GET /api/test-log/v1/:dtoType/read/:id
...
import * as TestLogReadPipeline from "./pipelines/test-log.read.handlerPipeline";
...
export class TestLogReadController extends ControllerJsonBase {
  ...
  public async get(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "test-log": {
        const steps = TestLogReadPipeline.getSteps(ctx, this);
