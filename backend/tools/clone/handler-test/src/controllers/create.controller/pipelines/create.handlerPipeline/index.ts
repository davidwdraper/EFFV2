// backend/services/handler-test/src/controllers/handler-test.create.controller/pipelines/handler-test.create.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "handler-test" CREATE.
