...
/\*_ Factory: keeps ctor private and centralizes DI wiring. _/
...
/\*_ Private to enforce factory usage. _/
private constructor(opts: { service?: string }, repo: RoutePolicyRepo) {
super(opts);
this.repo = repo;
}

/\*_ GET /routePolicy?svcconfigId=...&version=...&method=...&path=... _/
