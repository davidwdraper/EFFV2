// backend/services/t_entity_crud/src/controllers/xxx.create.controller/handlers/dtoFromJson.create.handler.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Hydrate and validate the Xxx DTO from inbound payload.
