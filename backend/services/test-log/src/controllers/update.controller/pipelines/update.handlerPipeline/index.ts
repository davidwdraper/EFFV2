// backend/services/test-log/src/controllers/test-log.update.controller/pipelines/test-log.update.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "test-log" UPDATE.
...
export function getSteps(ctx: HandlerContext, controller: ControllerJsonBase) {
  ...
  ctx.set("update.dtoCtor", TestRunDto);
