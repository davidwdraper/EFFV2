// backend/services/prompt/src/controllers/prompt.delete.controller/prompt.delete.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate DELETE /api/prompt/v1/:dtoType/delete/:id
...
import * as PromptDeletePipeline from "./pipelines/prompt.delete.handlerPipeline";

export class PromptDeleteController extends ControllerJsonBase {
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "prompt": {
        const steps = PromptDeletePipeline.getSteps(ctx, this);
