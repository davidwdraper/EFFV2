// backend/services/HandlerTest/src/app.ts
/**
 * Docs:
 ...
 * - For HandlerTest, DB/index ensure is ON (checkDb=true).
 */
...
class HandlerTestApp extends AppBase {
  ...
  constructor(opts: CreateAppOptions) {
    ...
    super({
      ...
      // HandlerTest is DB-backed: requires NV_MONGO_* and index ensure at boot.
      checkDb: true,
    });
