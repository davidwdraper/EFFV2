// backend/services/auth/src/controllers/auth.list.controller/handlers/dbRead.list.handler.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Use DbReader<AuthDto> to fetch a deterministic batch with cursor pagination.
