// backend/services/prompt/src/controllers/prompt.list.controller/handlers/dbRead.list.handler.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Use DbReader<PromptDto> to fetch a deterministic batch with cursor pagination.
