// backend/services/--audit--/src/dto/actDto.ts
...
/**
 * Build Audit response DTO after deep-normalizing the doc.
 * Matches the current Audit contract fields (post-refactor).
 * NOTE:
