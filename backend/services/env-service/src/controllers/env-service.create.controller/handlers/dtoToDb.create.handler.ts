// backend/services/env-service/src/controllers/env-service.create.controller/handlers/dtoToDb.create.handler.ts
/**
 * Docs:
...
import { XxxDto } from "@nv/shared/dto/templates/env-service/env-service.dto";
  ...
  protected async execute(): Promise<void> {
    ...
    if (!dto) {
      ...
      this.ctx.set("error", {
        code: "DTO_MISSING",
        message:
          "DTO not found in context. Ops: ensure dtoFromJson.create.handler runs first and sets ctx.set('dto', dto).",
        hint: "Verify handler order in env-service.create.controller.ts and that ControllerBase seeded 'body' correctly.",
      });
      this.log.debug(
