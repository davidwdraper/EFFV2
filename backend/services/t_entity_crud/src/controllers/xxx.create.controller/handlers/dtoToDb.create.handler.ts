// backend/services/t_entity_crud/src/controllers/xxx.create.controller/handlers/dtoToDb.create.handler.ts
/**
 * Docs:
  ...
  protected async execute(): Promise<void> {
    ...
    if (!dto) {
      ...
      this.ctx.set("error", {
        ...
        hint: "Verify handler order in xxx.create.controller.ts and that ControllerBase seeded 'body' correctly.",
      });
      this.log.debug(
