// backend/services/gateway/src/controllers/gateway.update.controller/handlers/bagToDb.update.handler.ts
/**
 * Docs:
 ...
 *
 * Inputs (ctx):
 * - "bag": DtoBag<GatewayDto>   (UPDATED singleton; from ApplyPatchUpdateHandler)
 *
 * Outputs (ctx):
 * - "result": { ok: true, id }
 * - "status": 200
