// backend/services/svcconfig/src/controllers/svcconfig.delete.controller/svcconfig.delete.controller.ts
/**
 * Docs:
...
export class SvcconfigDeleteController extends ControllerJsonBase {
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "svcconfig": {
        const steps = SvcconfigDeletePipeline.getSteps(ctx, this);
