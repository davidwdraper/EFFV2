// backend/services/shared/src/dto/auth.dto.ts
/**
 * Docs:
...
export class AuthDto extends DtoBase {
  ...
  public constructor(
    ...
    super(secretOrMeta);
    this.setCollectionName(AuthDto.dbCollectionName());
  }
  ...
  public static fromBody(json: unknown, opts?: { validate?: boolean }): AuthDto {
