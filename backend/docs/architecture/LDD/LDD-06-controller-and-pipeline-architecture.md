...
- How DTO registry hydration integrates into the flow
- Finalization rules, including Problem+JSON formatting
...
### 3.1 Invariants
- Keys must be well-named, namespaced (“hydrate.fromJson”, “db.collectionName”)
