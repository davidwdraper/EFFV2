// backend/services/auth/src/controllers/auth.update.controller/pipelines/auth.update.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "auth" UPDATE.
...
export function getSteps(ctx: HandlerContext, controller: ControllerJsonBase) {
  ...
  ctx.set("update.dtoCtor", AuthDto);
