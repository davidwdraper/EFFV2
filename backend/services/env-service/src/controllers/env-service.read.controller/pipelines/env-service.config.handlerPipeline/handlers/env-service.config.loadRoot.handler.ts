// backend/services/env-service/src/controllers/env-service.read.controller/pipelines/env-service.config.handlerPipeline/handlers/env-service.config.loadRoot.handler.ts
/**
 * Docs:
