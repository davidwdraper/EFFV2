// backend/services/user/src/controllers/user.update.controller/pipelines/user.update.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "user" UPDATE.
...
export function getSteps(ctx: HandlerContext, controller: ControllerBase) {
  ...
  ctx.set("update.dtoCtor", UserDto);
