// backend/services/prompt/src/controllers/prompt.update.controller/handlers/bagToDb.update.handler.ts
/**
 * Docs:
 ...
 *
 * Inputs (ctx):
 * - "bag": DtoBag<PromptDto>   (UPDATED singleton; from ApplyPatchUpdateHandler)
 *
 * Outputs (ctx):
 * - "result": { ok: true, id }
 * - "status": 200
