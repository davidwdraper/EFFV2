 ...
 *
 * Purpose:
 * - Orchestrate GET /api/svcconfig/v1/:dtoType/read/:id
...
import * as SvcconfigReadPipeline from "./pipelines/svcconfig.read.handlerPipeline";
...
export class SvcconfigReadController extends ControllerBase {
  ...
  public async get(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "svcconfig": {
        const steps = SvcconfigReadPipeline.getSteps(ctx, this);
