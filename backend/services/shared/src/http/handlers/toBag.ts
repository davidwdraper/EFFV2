  ...
  protected async execute(): Promise<void> {
    try {
      ...
      this.failWithError({
        ...
        detail:
          "A shared handler that creates a DtoBag with one or more Dto's from a wire envelope failed.",
        stage: "This is usually the 1st stage in a controller pipeline.",
        rawError: err,
        origin: {
          file: __filename, // optional; firstFrame will also populate file/line
        },
      });
    }
  }
