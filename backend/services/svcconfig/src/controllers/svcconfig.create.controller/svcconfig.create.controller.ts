// backend/services/svcconfig/src/controllers/svcconfig.create.controller/svcconfig.create.controller.ts
/**
 * Docs:
...
import * as SvcconfigCreatePipeline from "./pipelines/svcconfig.create.handlerPipeline";
...
export class SvcconfigCreateController extends ControllerBase {
  ...
  public async put(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "svcconfig": {
        ...
        const steps = SvcconfigCreatePipeline.getSteps(ctx, this);
