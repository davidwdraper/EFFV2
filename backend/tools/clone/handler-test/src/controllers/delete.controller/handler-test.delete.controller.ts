// backend/services/handler-test/src/controllers/handler-test.delete.controller/handler-test.delete.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate DELETE /api/handler-test/v1/:dtoType/delete/:id
...
import * as HandlerTestDeletePipeline from "./pipelines/delete.handlerPipeline";

export class HandlerTestDeleteController extends ControllerJsonBase {
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "handler-test": {
        const steps = HandlerTestDeletePipeline.getSteps(ctx, this);
