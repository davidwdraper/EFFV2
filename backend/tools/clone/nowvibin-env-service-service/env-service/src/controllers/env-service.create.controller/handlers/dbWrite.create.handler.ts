// backend/services/env-service/src/controllers/env-service.create.controller/handlers/dbWrite.create.handler.ts
/**
 * Docs:
 * - ADR-0040/41/42/43/44
 *
 * Purpose:
 * - Execute DB write for PUT /api/env-service/v1/create.
 * - On duplicate key:
  ...
  constructor(ctx: HandlerContext) {
    super(
      ...
      (c, { id }) => {
        ...
        const writer = c.get<DbWriter<EnvServiceDto>>("dbWriter");
