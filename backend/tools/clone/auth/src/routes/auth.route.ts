...
import { AuthCreateController } from "../controllers/create.controller/auth.create.controller";
import { AuthReadController } from "../controllers/read.controller/auth.read.controller";
import { AuthDeleteController } from "../controllers/delete.controller/auth.delete.controller";
import { AuthUpdateController } from "../controllers/update.controller/auth.update.controller";
import { AuthListController } from "../controllers/list.controller/auth.list.controller";
