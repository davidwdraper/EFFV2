 ...
 * - For TestLog, DB/index ensure is ON (checkDb=true).
 */
...
class TestLogApp extends AppBase {
  ...
  constructor(opts: CreateAppOptions) {
    ...
    super({
      ...
      // TestLog is DB-backed: requires NV_MONGO_* and index ensure at boot.
      checkDb: true,
    });
