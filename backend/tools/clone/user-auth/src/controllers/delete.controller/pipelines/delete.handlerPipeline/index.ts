// backend/services/user-auth/src/controllers/user-auth.delete.controller/pipelines/user-auth.delete.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "user-auth" DELETE.
