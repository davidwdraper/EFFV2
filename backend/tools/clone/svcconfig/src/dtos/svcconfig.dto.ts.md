// backend/services/shared/src/dto/templates/svcconfig/svcconfig.dto.ts
/**
 * Docs:
...
export class SvcconfigDto extends BaseDto implements IDto {
  // ← implements IDto
  ...
  public static fromJson(json: unknown, opts?: { validate?: boolean }): SvcconfigDto {
    const dto = new SvcconfigDto(BaseDto.getSecret());
  ...
  public toJson(): SvcconfigJson {
    ...
    const body = {
      ...
      type: "svcconfig" as const, // wire type (matches slug)
  ...
  // inside backend/services/shared/src/dto/templates/svcconfig/svcconfig.dto.ts
  ...
  public clone(newId?: string): this {
    ...
    const Ctor = this.constructor as typeof SvcconfigDto;
