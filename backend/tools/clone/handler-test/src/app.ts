 ...
 * - For handler-test, DB/index ensure is ON (checkDb=true).
 */
...
class handler-testApp extends AppBase {
  ...
  constructor(opts: CreateAppOptions) {
    ...
    super({
      ...
      // handler-test is DB-backed: requires NV_MONGO_* and index ensure at boot.
      checkDb: true,
    });
...
export default async function createApp(
  ...
  const app = new handler-testApp(opts);
