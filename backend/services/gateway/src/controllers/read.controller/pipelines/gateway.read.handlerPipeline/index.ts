// backend/services/gateway/src/controllers/gateway.read.controller/pipelines/gateway.read.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "gateway" READ (by id).
...
export function getSteps(ctx: HandlerContext, controller: ControllerBase) {
  ...
  ctx.set("read.dtoCtor", GatewayDto);
