// backend/services/shared/src/dto/env.dto.ts
/**
 * Docs:
...
export class EnvDto extends BaseDto {
  ...
  public static create(input: unknown): EnvDto {
    ...
    return new EnvDto(parsed.data);
  }

  public static fromJson(json: unknown): EnvDto;
  public static fromJson(json: unknown, opts: { validate: boolean }): EnvDto;
  public static fromJson(json: unknown, opts?: { validate: boolean }): EnvDto {
