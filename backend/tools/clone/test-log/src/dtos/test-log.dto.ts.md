// backend/services/shared/src/dto/test-log.dto.ts
/\*\*
...
-
- Purpose:
- - Concrete DTO for the template service ("test-log").
    \*/
...
export class TestLogDto extends DtoBase {
...
public static fromJson(json: unknown, opts?: { validate?: boolean }): TestLogDto {
const dto = new TestLogDto(DtoBase.getSecret());
const j = (json ?? {}) as Partial<TestLogJson>;
...
public toJson(): TestLogJson {
const body: TestLogJson = {
...
public patchFrom(json: Partial<TestLogJson>): this {
