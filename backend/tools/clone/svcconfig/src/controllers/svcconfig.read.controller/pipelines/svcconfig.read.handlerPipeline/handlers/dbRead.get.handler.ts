// backend/services/svcconfig/src/controllers/svcconfig.read.controller/handlers/dbRead.get.handler.ts
/**
 * Docs:
 ...
 * - dtoCtor must be seeded by the pipeline via ctx.set("read.dtoCtor", SvcconfigDto).
 */
  ...
  protected async execute(): Promise<void> {
    ...
    if (!id) {
      ...
      this.ctx.set("response.body", {
        ...
        title: "Bad Request",
        detail:
          "Route requires an 'id' path or query parameter. Example: GET /api/svcconfig/v1/:dtoType/read/<id>",
        requestId,
      });
      return;
    }
