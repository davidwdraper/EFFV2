// backend/services/gateway/src/controllers/gateway.create.controller/gateway.create.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate PUT /api/gateway/v1/:dtoType/create
...
import * as GatewayCreatePipeline from "./pipelines/create.handlerPipeline";
...
export class GatewayCreateController extends ControllerJsonBase {
  ...
  public async put(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "gateway": {
        ...
        const steps = GatewayCreatePipeline.getSteps(ctx, this);
