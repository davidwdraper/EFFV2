// backend/services/test-log/src/controllers/test-log.delete.controller/test-log.delete.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate DELETE /api/test-log/v1/:dtoType/delete/:id
...
import * as TestLogDeletePipeline from "./pipelines/delete.handlerPipeline";

export class TestLogDeleteController extends ControllerJsonBase {
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "test-log": {
        const steps = TestLogDeletePipeline.getSteps(ctx, this);
