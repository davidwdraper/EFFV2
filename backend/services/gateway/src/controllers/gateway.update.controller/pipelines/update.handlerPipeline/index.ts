// backend/services/gateway/src/controllers/gateway.update.controller/pipelines/gateway.update.handlerPipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "gateway" UPDATE.
...
export function getSteps(ctx: HandlerContext, controller: ControllerBase) {
  ...
  ctx.set("update.dtoCtor", GatewayDto);
