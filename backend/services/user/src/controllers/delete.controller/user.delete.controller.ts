// backend/services/user/src/controllers/user.delete.controller/user.delete.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate DELETE /api/user/v1/:dtoType/delete/:id
...
import * as UserDeletePipeline from "./pipelines/delete.handlerPipeline";
...
export class UserDeleteController extends ControllerJsonBase {
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "user": {
        const steps = UserDeletePipeline.getSteps(ctx, this);
