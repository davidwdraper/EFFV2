// backend/services/handler-test/src/controllers/handler-test.read.controller/handler-test.read.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate GET /api/handler-test/v1/:dtoType/read/:id
...
import * as HandlerTestReadPipeline from "./pipelines/handler-test.read.handlerPipeline";
...
export class HandlerTestReadController extends ControllerJsonBase {
  ...
  public async get(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "handler-test": {
        const steps = HandlerTestReadPipeline.getSteps(ctx, this);
