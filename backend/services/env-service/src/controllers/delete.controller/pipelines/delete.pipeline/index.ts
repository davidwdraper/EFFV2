// backend/services/env-service/src/controllers/delete.controller/pipelines/delete.pipeline/index.ts
/**
 * Docs:
 * - Inherit controller docs (SOP + ADRs)
 *
 * Purpose:
 * - Define ordered handler steps for dtoType "env-service" DELETE.
...
import { DbDeleteDeleteHandler } from "./handlers/delete.handler";
