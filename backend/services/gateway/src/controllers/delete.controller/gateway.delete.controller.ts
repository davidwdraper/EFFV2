// backend/services/gateway/src/controllers/gateway.delete.controller/gateway.delete.controller.ts
/**
 * Docs:
 ...
 *
 * Purpose:
 * - Orchestrate DELETE /api/gateway/v1/:dtoType/delete/:id
...
import * as GatewayDeletePipeline from "./pipelines/delete.handlerPipeline";

export class GatewayDeleteController extends ControllerJsonBase {
  ...
  public async delete(req: Request, res: Response): Promise<void> {
    ...
    switch (dtoType) {
      case "gateway": {
        const steps = GatewayDeletePipeline.getSteps(ctx, this);
