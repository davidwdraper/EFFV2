// backend/services/svcconfig/src/controllers/svcconfig.create.controller/handlers/bagToDb.create.handler.ts
/**
 * Docs:
...
export class BagToDbCreateHandler extends HandlerBase {
  ...
  protected async execute(): Promise<void> {
    ...
    if (!bag) {
      this._badRequest(
        "BAG_MISSING",
        'Missing items. Provide JSON body { items:[{ type:"svcconfig", ... }] }.'
      );
      return;
    }
