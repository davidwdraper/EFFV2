// backend/services/env-service/src/controllers/env-service.update.controller/handlers/bagToDb.update.handler.ts
/**
 * Docs:
...
export class BagToDbUpdateHandler extends HandlerBase {
  ...
  protected async execute(): Promise<void> {
    ...
    // --- Writer (bag-centric) -----------------------------------------------
    const writer = new DbWriter<EnvServiceDto>({ bag, svcEnv });
